...
// +-------------------------------------------------+
// $Id: cms_module_animationslist_datasource_animations_by_type.class.php,v 1.4.6.1 2025/01/17 10:40:46 gneveu Exp $
...
class cms_module_animationslist_datasource_animations_by_type extends cms_module_common_datasource_animations_list
{
    ...
    public function get_datas()
    {
        ...
        if (! empty($selector) && $selector->get_value()) {
            ...
            if (!is_countable($data['animations']) || !count($data['animations'])) {
                return false;
            }
