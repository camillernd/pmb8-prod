...
// +-------------------------------------------------+
// $Id: opac_view_filters_facettes.class.php,v 1.1.2.2.2.1 2025/03/14 13:27:22 dgoron Exp $
...
class opac_view_filters_facettes extends opac_view_filters {
    ...
    public function fetch_data() {
		parent::fetch_data();
		$myQuery = pmb_mysql_query("SELECT * FROM facettes WHERE num_facettes_set = 0 order by facette_name ");
	...
	public function save_form(){
		...
		$req = "select id_facette, facette_opac_views_num from facettes WHERE num_facettes_set = 0";
