...
// +-------------------------------------------------+
// $Id: etagere_caddies.class.php,v 1.5.4.1 2025/04/24 09:50:00 qvarin Exp $
...
class etagere_caddies {
	...
	public function del_item($item=0) {
		$requete = "delete FROM etagere_caddie where etagere_id='".$this->etagere."' and caddie_id='".$item."' ";
		pmb_mysql_query($requete);
	}
