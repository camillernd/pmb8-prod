...
// +-------------------------------------------------+
// $Id: connecteurs.class.php,v 1.82.2.2.2.7 2025/04/16 12:16:51 dbellamy Exp $
...
class connecteurs {
    ...
    public function show_connector_form($id) {
        ...
        switch ($conn->is_repository()) {
            ...
            // Au choix
            case connector::REPOSITORY_CHOOSE :
    ...
    public function show_source_form($id,$source_id="") {
        ...
        $rep_upload_form="
                <select name='rep_upload' id='rep_upload' >";
    ...
    public static function get_connector_instance_from_source_id($source_id=0) {
        ...
        if (!empty($contrs->catalog[$catalog_id])) {
