...
// +-------------------------------------------------+
// $Id: sphinx_base.class.php,v 1.19.4.1 2025/05/02 12:00:29 dbellamy Exp $
...
class sphinx_base
{
    ...
    {
        global $sphinx_active, $sphinx_mysql_connect, $dbh;
        if (!$sphinx_active || !$sphinx_mysql_connect) {
            return $dbh;
        }
