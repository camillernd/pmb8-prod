...
// +-------------------------------------------------+
// $Id: parse_format.class.php,v 1.26.2.1 2024/10/31 10:07:42 qvarin Exp $
            ...
            switch ($state) {
                ...
                case 'get_token': //get param name
                    ...
                    switch ($cmd[$i]) {
                        ...
                        case "\n":
                        case "\t":
							//La liste de caractères précédente permet de déterminer qu'on doit sortir de l'interpretation
        ...
        for ($i = 0; $i < $strlen_cmd; $i++) {
            switch ($cmd[$i]) {
                ...
                case '#':
                    ...
                    break;
                default:
                    if (!$no_escape && ($cmd[$i] == '\\') && (($i + 1) < $strlen_cmd)) {
						$i++;
                    }
                    $ret .= $cmd[$i];
                    break;
