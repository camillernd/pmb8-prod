...
// +-------------------------------------------------+
// $Id: cms_module_recordslist_selector_publisher.class.php,v 1.3.16.1 2025/02/12 12:34:08 dbellamy Exp $
		...
		if(!$this->value){
			...
			if($this->parameters['sub_selector']) {
				...
				if($sub_selector_value){
				    ...
				    $query = "select ed1_id from notices where notice_id = '".$sub_selector_value."'";
