...
// +-------------------------------------------------+
// $Id: sru.class.php,v 1.9.4.2 2025/05/07 14:25:38 qvarin Exp $
...
class sru extends connector {
    ...
    /*Renvoi le formulaire de proprietes de la source
     */
...
//
//Choix d'une recherche global en cas d'echec de construction CQL.
//
...
//    		highlight_string(print_r(${$aname}, true));
	...
	/* Convertit une recherche multi-criteres PMB en CQL SRU
